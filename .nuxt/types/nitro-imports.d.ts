declare global {
  ...
  const MEDIA_TYPES: typeof import('../../server/utils/catalog').MEDIA_TYPES
  ...
  const requireUser: typeof import('../../server/utils/catalog').requireUser
  ...
  const sendPushToOthers: typeof import('../../server/utils/push').sendPushToOthers
